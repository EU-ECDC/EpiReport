...
#' @return ?
#' @export
getMap <- function(x, disease = "SALM", year = 2016,
  ...
  if(reportParameters$Map.numbers.use == "Y") {
    ...
    ## ----- Map
    namePNG <- paste(pathPNG, "/", disease, "_", year, ".CONFIRMED.COUNT.png", sep = "")
  ...
  if(reportParameters$Map.rates.use == "Y") {
    ...
    ## ------ Maps
    namePNG <- paste(pathPNG, "SALM_2016.CONFIRMED.RATE.png", sep = "/")
  ...
  if(reportParameters$Map.ASR.use == "Y") {
    ...
    ## ----- Map
    namePNG <- paste(pathPNG, "SALM_2016.CONFIRMED.AGESTANDARDISED.RATE.png", sep = "/")
